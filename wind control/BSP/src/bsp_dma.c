...
const u16  DMA_JUDGE_RECEIVE_BUF_SIZE = 30	;//接受缓存区数据的长度
const u16  DMA_JUDGE_SEND_BUF_SIZE 	= 30	;//发送缓存区数据长度
const u16 DMA_VISION_SEND_BUF_SIZE = 20;
const u16 DMA_VISION_RECEIVE_BUF_SIZE = 20;
