...
//		g_cloud_gyroscope.gx=g_chebyshev_filter.filtered_value;
		...
		g_cloud_gyroscope.last_gx = g_cloud_gyroscope.gx;
		g_cloud_gyroscope.last_gy = g_cloud_gyroscope.gy;
		g_cloud_gyroscope.last_gz = g_cloud_gyroscope.gz;
		g_cloud_gyroscope.gx=-raw_gx;//PITCH
		g_cloud_gyroscope.gy=-raw_gy;
		g_cloud_gyroscope.gz=-raw_gz;//YAW
		
		if(ABS(g_cloud_gyroscope.last_gx - g_cloud_gyroscope.gx) > 1500)  g_cloud_gyroscope.gx = g_cloud_gyroscope.last_gx;
